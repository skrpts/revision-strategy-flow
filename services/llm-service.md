...
id: llm-service
title: LLM Service
description: "Language model service providing study planning and revision strategy capabilities"
tags: [Production]
connections: []
metadata:
  serviceType: llm
...
Provides access to a large language model for study planning and revision strategy. Used by all skills in this skrpt.
